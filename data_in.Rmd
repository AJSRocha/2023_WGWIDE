...
```{r}
fleet_frg2 = read.csv('fleet_frg2.csv')
```


```{sql,connection=con,output.var=gux_2020_cmp}
       ...
       group by z.viagem)x 
          ...
          where p2.viagem=p1.id and 
           ...
           from pnab.viagem_regiao where regiao <> 5) and
                ...
                p2.data between '2020-01-01' and '2020-12-31' 
      ...
      case when rpo.desig = 'Norte' then 'NW' when 
        ...
        (select viagem id 
          ...
          where regiao <> 5) and
                p9.n_nao_observados is not null and 
                p8.cod_fao in ('CTZ','GUG','GUM','GUN','GUR','GUU','GUX','LDV','LEP','GUY') and
                p2.data between '2020-01-01' and '2020-12-31' and
                p1.id not in(
...
select distinct p1.id id_viagem,
	 ...
	 from (select z.viagem,count(*) contagem 
         ...
         select viagem id 
          ...
          where regiao <> 5) and 
                p9.n_nao_observados is not null and 
                p2.data between '2017-01-01' and '2020-12-31' and 
                p1.id in(
select distinct p1.id 
           from pnab.viagem p1,
                pnab.venda p2,
         ...
         select viagem id 
          ...
          where regiao <> 5) and 
                p8.cod_fao in ('CTZ','GUG','GUM','GUN','GUR','GUU','GUX','LDV','LEP','GUY') and
                p2.data between '2017-01-01' and '2020-12-31'
                           )
       UNION ALL
select distinct p1.id id_viagem,
                p2.id id_venda,
